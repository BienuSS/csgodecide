...
?>
	...
	<nav class="navigation" role="navigation">
		...
		<ul id="menu-desktop">
			...
			<li id="gambling-nav"><a href="gambling.php"><b><strong class="span-menu">Gambling Modes</strong></b><img src="img/roulette.png"/></a></li>
...
<div class="main-site">
	...
	<div id="tlo-spin"><img src="tlo-spin1.png" style="z-index:-1; position: absolute; top:10%; left:-40%;"></div>
							   ...
							   <div id='spin-it'><button  id='dailfree-button' onclick='show()'><b><i>Spin it</i></b></button></div>   
